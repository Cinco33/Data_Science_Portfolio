...
* Created visualizations and geographic insights for trend analysis
* Prepared data for use in visualization tools such as Tableau
...
* Evaluated **inventory valuation assertions** using analytical procedures
* Analyzed **commission data** to assess reasonableness and outliers
...
* Implemented CRUD operations and data retrieval logic
* Integrated database queries with Python and Jupyter Notebooks
...
* Built **scatter plots, histograms, and linear regression models**
* Performed full EDA including data cleaning and transformation
...
* Practiced database-backed application logic and query integration
